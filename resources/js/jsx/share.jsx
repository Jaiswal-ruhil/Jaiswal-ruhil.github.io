...
const selectedLike = true
const selectedBookmark = true

const SvgButton = (props) => <div><IconButton {...props}>
    <SvgIcon width="29" height="29" viewBox="0 0 29 29">
        {props.children}
    </SvgIcon>
</IconButton></div>

const tweet = (url, name) => {
    const myWindow = window.open(url, name, "width=400,height=300");
}

const Share = (props) => <div className="u-textAlignCenter">
    <Subheader>Share</Subheader>
    <SvgButton tooltip="like">{selectedLike
        ...
        : <path d="M19.5 4c-1.948 0-3.77.898-5 2.434C13.27 4.898 11.448 4 9.5 4 5.916 4 3 7.02 3 10.734c0 4.793 6.227 10 9.95 13.11.296.25.853.723 1.212 1.03.196.166.48.166.677 0 .39-.332 1.02-.87 1.37-1.158 3.66-3.022 9.79-8.08 9.79-12.982C26 7.02 23.08 4 19.5 4z" fillRule="evenodd"></path>
    }</SvgButton>
    <SvgButton tooltip="twitter" onTouchTap={() => tweet(
        `https://twitter.com/intent/tweet?text=Checkout%20this%20post%20${window.location.href}`,
        "tweet"
    )}>
    ...
    <SvgButton tooltip="bookmark">{selectedBookmark
        ...
        : <path d="M19.385 4h-9.77A2.623 2.623 0 0 0 7 6.615V23.01a1.022 1.022 0 0 0 1.595.847l5.905-4.004 5.905 4.004A1.022 1.022 0 0 0 22 23.011V6.62A2.625 2.625 0 0 0 19.385 4z" fillRule="evenodd"></path>
    }
    </SvgButton>
</div>
